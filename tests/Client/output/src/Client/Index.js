...
export const todos = Remoting_buildProxy_Z15584635(RemotingModule_withRouteBuilder(Route_builder, RemotingModule_createApi()), {
...
export function init() {
    ...
    const cmd = Cmd_OfAsyncWith_perform((x) => {
        Cmd_OfAsync_start(x);
    }, todos.find, void 0, (arg0) => (new Msg(0, arg0)));
    return [model, cmd];
}
...
export function update(msg, model) {
    switch (msg.tag) {
        ...
        case 2: {
            ...
            const cmd = Cmd_OfAsyncWith_perform((x) => {
                Cmd_OfAsync_start(x);
            }, todos.addTodo, todo, (arg0) => (new Msg(3, arg0)));
        ...
        default: {
            const todos_1 = msg.fields[0];
            return [new Model(todos_1, model.input), Cmd_none()];
        }
    }
}
...
export function view(model, dispatch) {
    ...
    const props_9 = ofArray([["className", "is-fullheight"], ["className", "is-primary"], ["style", {
        ...
        className: "hero-head",
        children: Interop_reactApi.Children.toArray(Array.from(elms_2)),
    })), (elms_4 = singleton((elms_3 = singleton((props_5 = ofArray([["className", "is-6"], ["className", "is-offset-3"], (elems_3 = [createElement("h1", createObj(Helpers_combineClasses("title", ofArray([["className", "has-text-centered"], ["children", "test_actions_safestack"]])))), containerBox(model, dispatch)], ["children", Interop_reactApi.Children.toArray(Array.from(elems_3))])]), createElement("div", createObj(Helpers_combineClasses("column", props_5))))), createElement("div", {
        className: "container",
